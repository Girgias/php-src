...
#define ZEND_PROPERTY_INFO_SOURCE_FROM_LIST(list) (0x1u | (uintptr_t) (list))
#define ZEND_PROPERTY_INFO_SOURCE_TO_LIST(list) ((zend_property_info_list *) ((list) & ~0x1u))
#define ZEND_PROPERTY_INFO_SOURCE_IS_LIST(list) ((list) & 0x1u)
...
#define Z_TYPE_MASK					0xffu
#define Z_TYPE_FLAGS_MASK			0xff00u
...
#define GC_TYPE_MASK				0x0000000fu
#define GC_FLAGS_MASK				0x000003f0u
#define GC_INFO_MASK				0xfffffc00u
