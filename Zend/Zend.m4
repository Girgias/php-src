...
test -n "$GCC" && CFLAGS="$CFLAGS -std=c99 -D_POSIX_C_SOURCE=199506L -Wall -Wextra -Wno-strict-aliasing -Wno-implicit-fallthrough -Wno-unused-parameter -Wno-sign-compare"
