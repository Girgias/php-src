...
test -n "$GCC" && CFLAGS="$CFLAGS -std=c99 -D_POSIX_C_SOURCE=200112 -Wall -Wextra -Wno-strict-aliasing -Wno-implicit-fallthrough -Wno-unused-parameter -Wno-sign-compare"
