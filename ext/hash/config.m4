...
if test $ac_cv_c_bigendian_php = yes; then
  ...
  PHP_HASH_CFLAGS="-Wno-implicit-fallthrough -Wno-sign-conversion -I@ext_srcdir@/$SHA3_DIR -DKeccakP200_excluded -DKeccakP400_excluded -DKeccakP800_excluded -DZEND_ENABLE_STATIC_TSRMLS_CACHE=1"
