 ...
 * Stub hash: 72af148e00b5754eabc836bc4696e5293f7f16a7 */
...
static void register_test_symbols(int module_number)
{
	...
	attribute_Deprecated_func_zend_test_deprecated_attr_0->args[0].name = zend_string_init_interned("message", sizeof("message") - 1, 1);
...
static zend_class_entry *register_class__ZendTestClass(zend_class_entry *class_entry__ZendTestInterface)
{
	...
	attribute_Deprecated_const_ZEND_TEST_DEPRECATED_ATTR_0->args[0].name = zend_string_init_interned("message", sizeof("message") - 1, 1);
