...
static zend_class_entry *register_class_ReflectionFunction(zend_class_entry *class_entry_ReflectionFunctionAbstract)
{
	...
	zend_string *attribute_name_Deprecated_func_isdisabled_0 = zend_string_init_interned("Deprecated", sizeof("Deprecated") - 1, 1);
	zend_attribute *attribute_Deprecated_func_isdisabled_0 = zend_add_function_attribute(zend_hash_str_find_ptr(&class_entry->function_table, "isdisabled", sizeof("isdisabled") - 1), attribute_name_Deprecated_func_isdisabled_0, 1);
	zend_string_release(attribute_name_Deprecated_func_isdisabled_0);
...
static zend_class_entry *register_class_ReflectionParameter(zend_class_entry *class_entry_Reflector)
{
	...
	zend_string *attribute_name_Deprecated_func_getclass_0 = zend_string_init_interned("Deprecated", sizeof("Deprecated") - 1, 1);
	zend_attribute *attribute_Deprecated_func_getclass_0 = zend_add_function_attribute(zend_hash_str_find_ptr(&class_entry->function_table, "getclass", sizeof("getclass") - 1), attribute_name_Deprecated_func_getclass_0, 1);
	zend_string_release(attribute_name_Deprecated_func_getclass_0);
	...
	zend_string_release(attribute_name_Deprecated_func_isarray_0);
	...
	zend_string_release(attribute_name_Deprecated_func_iscallable_0);
