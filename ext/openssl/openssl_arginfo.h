...
static void register_openssl_symbols(int module_number)
{
	...
	zend_string *attribute_name_Deprecated_func_openssl_x509_free_0 = zend_string_init_interned("Deprecated", sizeof("Deprecated") - 1, 1);
	zend_add_function_attribute(zend_hash_str_find_ptr(CG(function_table), "openssl_x509_free", sizeof("openssl_x509_free") - 1), attribute_name_Deprecated_func_openssl_x509_free_0, 0);
	zend_string_release(attribute_name_Deprecated_func_openssl_x509_free_0);
	...
	zend_string *attribute_name_Deprecated_func_openssl_pkey_free_0 = zend_string_init_interned("Deprecated", sizeof("Deprecated") - 1, 1);
	zend_add_function_attribute(zend_hash_str_find_ptr(CG(function_table), "openssl_pkey_free", sizeof("openssl_pkey_free") - 1), attribute_name_Deprecated_func_openssl_pkey_free_0, 0);
	zend_string_release(attribute_name_Deprecated_func_openssl_pkey_free_0);

	zend_string *attribute_name_Deprecated_func_openssl_free_key_0 = zend_string_init_interned("Deprecated", sizeof("Deprecated") - 1, 1);
	zend_add_function_attribute(zend_hash_str_find_ptr(CG(function_table), "openssl_free_key", sizeof("openssl_free_key") - 1), attribute_name_Deprecated_func_openssl_free_key_0, 0);
	zend_string_release(attribute_name_Deprecated_func_openssl_free_key_0);
